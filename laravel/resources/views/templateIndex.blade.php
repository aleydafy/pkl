...
<html lang="en">
   <head>
      ...
      <!-- page title -->
      <title>Animals | Tropis Animal In The World</title>
      <!--[if lt IE 9]>
   ...
   <body id="top">
	 ...
	 <!-- ==== Slider ==== -->
      <div id="slider" style="width:1200px;height:800px;margin:0 auto;margin-bottom: 0px;">
         <!-- Slide 1 -->
         <div class="ls-slide" data-ls="duration:3000; transition2d:7; kenburnszoom:out; kenburnsrotate:-5; kenburnsscale:1.2;">
            <!-- bg image  -->
            <img src="assets/img/group77.png" class="ls-bg" alt="" />
            <!-- text  -->
         ...
         <div class="ls-slide" data-ls="duration:4000; transition2d:7; kenburnszoom:out; kenburnsrotate:-5; kenburnsscale:1.2;">
            <!-- bg image  -->
            <img src="assets/img/juliana-castro-LdEZjO3wjqQ-unsplash.png" class="ls-bg" alt="" />
            <!-- text  -->
            <div class="ls-l header-wrapper" data-ls="offsetyin:150; durationin:700; delayin:200; easingin:easeOutQuint; rotatexin:20; scalexin:1.4; offsetyout:600; durationout:400; parallaxlevel:0;">
         ...
         <div class="ls-slide" data-ls="duration:4000; transition2d:7; kenburnszoom:out; kenburnsrotate:-5; kenburnsscale:1.2;">
            <!-- bg image  -->
            <img src="assets/img/pascal-muller-iSz0IMtulos-unsplash.png" class="ls-bg" alt="" />
            <!-- text  -->
            <div class="ls-l header-wrapper" data-ls="offsetyin:150; durationin:700; delayin:200; easingin:easeOutQuint; rotatexin:20; scalexin:1.4; offsetyout:600; durationout:400; parallaxlevel:0;">
               <div class="header-text dog-elements">
         ...
         <div class="ls-slide" data-ls="duration:4000; transition2d:7; kenburnszoom:out; kenburnsrotate:-5; kenburnsscale:1.2;">
            <!-- bg image  -->
            <img src="assets/img/smit-patel-dGMcpbzcq1I-unsplash.png" class="ls-bg" alt="" />
            <!-- text  -->
            <div class="ls-l header-wrapper" data-ls="offsetyin:150; durationin:700; delayin:200; easingin:easeOutQuint; rotatexin:20; scalexin:1.4; offsetyout:600; durationout:400; parallaxlevel:0;">
               <div class="header-text cat-elements">
         ...
         <div class="container">
            ...
            <div class="container block-padding pt-0">
               <div class="row">
                  ...
                  <!-- /col-xl-->
                  <div class="col-xl-6">
                     <img src="img/services2.jpg" alt=""   data-aos="fade-down"  data-aos-duration="1500"  class="img-fluid border-irregular1 border-double">
                  </div>
               </div>
               <!-- /row -->
            </div>
      ...
      <section id="blurb" class="bg-primary text-light">
         <div class="container">
            <div class="row">
               <div class="col-xl-8">
                  <!-- image  -->
                  <img src="img/blurbimg.png" class="img-fluid blurb-img" alt="" />
               </div>
            ...
            <div class="container">
               <div id="owl-team2" class="owl-carousel owl-theme mt-5">
                  ...
                  <figure class="col-lg-12 team-style2">
                     <!-- image -->
                     <img src="img/team/team1.jpg" alt="" class="img-fluid"/>
                     <figcaption>
                        <!-- social icons -->
                        <div class="icons">
                  ...
                  <figure class="col-lg-12 team-style2">
                     <!-- image -->
                     <img src="img/team/team2.jpg" alt="" class="img-fluid"/>
                     <figcaption>
                        <!-- social icons -->
                        <div class="icons">
                           <a href="#"><i class="fa fa-envelope"></i></a>
                  ...
                  <figure class="col-lg-12 team-style2">
                     <!-- image -->
                     <img src="img/team/team3.jpg" alt="" class="img-fluid"/>
                     <figcaption>
                        <!-- social icons -->
                        <div class="icons">
                           <a href="#"><i class="fa fa-envelope"></i></a>
                  ...
                  <figure class="col-lg-12 team-style2">
                     <!-- image -->
                     <img src="img/team/team4.jpg" alt="" class="img-fluid"/>
                     <figcaption>
                        <!-- social icons -->
                        <div class="icons">
                           <a href="#"><i class="fa fa-envelope"></i></a>
                  ...
                  <figure class="col-lg-12 team-style2">
                     <!-- image -->
                     <img src="img/team/team5.jpg" alt="" class="img-fluid"/>
                     <figcaption>
                        <!-- social icons -->
                        <div class="icons">
                           <a href="#"><i class="fa fa-envelope"></i></a>
